<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="ManageFeeBudgetImport" CodeBehind="ManageFeeBudgetImport.aspx.cs" %>
            ...
            <tr>
                <td>
                    <div class="field_title">
                        <asp:HyperLink ID="hlTemplateDownload" Text="导入模板下载" runat="server" NavigateUrl="~/TemplateExcel/BudgetManageFeeImportTemplate.xls"></asp:HyperLink></div>
                    <div>
