<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="SaleBudgetImport" CodeBehind="SalesFeeBudgetImport.aspx.cs" %>
            ...
            <tr>
                <td>
                    <div class="field_title">
                        <asp:HyperLink ID="hlTemplateDownload" Text="导入模板下载" runat="server" NavigateUrl="~/TemplateExcel/BudgetSalesFeeImportTemplate.xls"></asp:HyperLink></div>
                        <div>
