<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="QueryForm_FormApplySelectList" Title="方案申请单查询" Codebehind="FormApplySelectList.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <gc:GridView CssClass="GridView" ID="gvApplyList" runat="server" DataSourceID="odsApplyList" AutoGenerateColumns="False" DataKeyNames="FormID" AllowPaging="True"
            AllowSorting="True" PageSize="100" OnRowDataBound="gvApplyList_RowDataBound" >
        <Columns> 
            ...
            <asp:TemplateField SortExpression="CustomerName" HeaderText="客户名称">
                ...
                <ItemStyle Width="198px" HorizontalAlign="left" />
            </asp:TemplateField>
            ...
            <asp:TemplateField SortExpression="Amount" HeaderText="确认金额">
                <ItemTemplate>
            ...
            <asp:TemplateField SortExpression="PymentTypeID" HeaderText="支付方式">
                <ItemTemplate>
    ...
    <div style="margin-top: 20px; width: 1200px; text-align: right">
        <asp:Button ID="CreateBtn" runat="server" CssClass="button_nor" OnClick="CreateBtn_Click" Text="创建报销单"  />&nbsp;&nbsp;
    </div>
</asp:Content>
