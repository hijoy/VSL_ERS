...
function init(date_start,date_end)
{
     ...
     temp_str+="<input type=\"Button\" value=\"<<\" onclick=\"change_date(-1,1)\" onmouseover=\"getlayerfocus()\" class=btn style=margin-left:0px;> ";

     temp_str+="";
     temp_str+="<select name=\"cele_date_year\" id=\"cele_date_year\" language=\"javascript\" onchange=\"change_date(this.value,0)\" onmouseover=\"getlayerfocus()\" onblur=\"getlayerfocus()\" style=\"width:60px;font-size: 9pt; border: 1px #666666 outset; background-color: #F4F8FB\" id=\"Button\"1 name=\"Button\"1>";
     ...
     temp_str+="</select> ";
     temp_str+="";
     temp_str+="<input type=\"Button\" value=\">>\" onclick=\"change_date(1,1)\" onmouseover=\"getlayerfocus()\" class=btn style=margin-right:0px;>";
     tempmsg=temp_str;
     ...
     temp_str+="<tr>";
        for(j=1;j<=7;j++){
            temp_str+="<td  class=DateTd name=\"c"+i+"_"+j+"\"id=\"c"+i+"_"+j+"\" style=\"CURSOR: hand\" style=\"COLOR:#000000\" language=\"javascript\" onmouseover=\"overcolor(this)\" onmouseout=\"outcolor(this)\" onclick=\"td_click(this)\">?</td>";
            }
     temp_str+="</tr>";    
     }
     ...
     //Add by RichardZhang
     var myIframe = "<iframe src='javascript:false' style='position:absolute; visibility:inherit; top:0px; left:0px; width:210px; height:210px; z-index:-1; filter=progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);'></iframe>";
     temp_str+=myIframe;
