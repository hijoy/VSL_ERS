<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="CustomerImport" CodeBehind="CustomerImport.aspx.cs" %>
            ...
            <tr>
                <td>
                    <div class="field_title">
                        <asp:HyperLink ID="hlTemplateDownload" Text="导入模板下载" runat="server" NavigateUrl="~/TemplateExcel/CustomerImportTemplate.xls"></asp:HyperLink></div>
                    <div>
