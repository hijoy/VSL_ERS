<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="ReportManage_SalesPrintSingleReport" Codebehind="SalesTotalFeeReport.aspx.cs" %>
        ...
        <table class="searchTable" cellpadding="0" cellspacing="0">
            <tr style="vertical-align: top; height: 40px">
                ...
                <td valign="bottom" style="width: 200px;">
                    <asp:Button ID="btn_search" runat="server" CssClass="button_nor" Text="查询" 
